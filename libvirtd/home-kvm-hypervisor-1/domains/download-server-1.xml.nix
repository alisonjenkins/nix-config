{pkgs}: ''
  <domain type='kvm'>
    ...
    <os firmware='efi'>
      ...
      <nvram template='/run/libvirt/nix-ovmf/edk2-i386-vars.fd'>/var/lib/libvirt/qemu/nvram/download-server-1_VARS.fd</nvram>
    </os>
    <features>
      <acpi/>
      <apic/>
    ...
    <devices>
      ...
      <!-- Second NIC on the isolated jumbo (MTU 9000) storage bridge. Carries
           ...
           Multiqueue (queues=6) spreads NIC softirq across the 6 vCPUs. PCI
