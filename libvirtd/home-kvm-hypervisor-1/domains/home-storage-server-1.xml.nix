...
<domain type="kvm">
  <name>home-storage-server-1</name>
  <uuid>5180782f-6992-4457-a8a9-eee913a1c008</uuid>
  <metadata>
  ...
  <os firmware="efi">
    ...
    <nvram template="/run/libvirt/nix-ovmf/edk2-i386-vars.fd">/var/lib/libvirt/qemu/nvram/home-storage-server-1_VARS.fd</nvram>
    <bootmenu enable="no"/>
  </os>
  <features>
    <acpi/>
  ...
  <devices>
    ...
    <!-- Second NIC on the isolated jumbo (MTU 9000) storage bridge. Serves NFS
         to download-server-1 (10.10.10.1) off the LAN br0. Multiqueue (queues=8)
         spreads NIC softirq across the 8 vCPUs. PCI address omitted so libvirt
