...
though it can invoke one by exact name. Name the ones this problem needs —
`invoke the debugging skill and read its false-signals.md` — the same rule that
already applies to any subagent prompt.
