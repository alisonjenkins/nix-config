    ...
    ".config/river/init" = {
      text = ''
        ...
        do
          ...
          riverctl map $mode None XF86AudioRaiseVolume  spawn '${pkgs.wireplumber}/bin/wpctl set-volume @DEFAULT_SINK@ 5%+'
          riverctl map $mode None XF86AudioLowerVolume  spawn '${pkgs.wireplumber}/bin/wpctl set-volume @DEFAULT_SINK@ 5%-'
          riverctl map $mode None XF86AudioMute         spawn '${pkgs.wireplumber}/bin/wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle'
