    ...
    services = {
      ananicy = {
        ...
        extraRules = [
          ...
          # VR runtime — latency-sensitive compositor-level processes
          { name = "wivrn-server"; nice = -15; ioclass = "realtime"; }
          { name = "monado-service"; nice = -15; ioclass = "realtime"; }
          { name = "wivrn-dashboard"; nice = -5; }
