{ ... }: {
  flake.nixosModules.ali-work-laptop-hardware = { config, lib, modulesPath, ... }: {
    imports = [
    ...
    # Swap is configured in disko-config.nix with resumeDevice = true
    # Do not duplicate here to avoid systemd-fstab-generator conflicts
